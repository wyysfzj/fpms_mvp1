...
from app.modules.documents.official_notice_catalog import (
    seed_official_letter_out_form_004_catalog as seed_doc_templates,
)
...
def test_seed_accumulates_form_004_internal_only_after_forms_001_through_003(
    ...
    with session_factory() as transaction:
        ...
        for row, scope in zip(
            classified,
            ("form-001", "form-002", "form-003", "form-004"),
            strict=True,
        ):
