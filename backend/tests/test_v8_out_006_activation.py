...
from app.modules.documents.official_notice_catalog import (
    seed_official_letter_out_form_006_catalog as seed_doc_templates,
)
...
def test_seed_accumulates_form_006_internal_only_after_forms_001_through_005(
    ...
    with session_factory() as transaction:
        ...
        for row, scope in zip(
            classified,
            ("form-001", "form-002", "form-003", "form-004", "form-005", "form-006"),
            strict=True,
        ):
