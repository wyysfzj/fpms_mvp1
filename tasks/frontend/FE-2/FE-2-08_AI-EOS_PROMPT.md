# AI‑EOS PROMPT — FE-2-08
## Title
Tasks: Close / Reopen / Cancel actions with 409 UX
...
## Objective
Add task status transition actions.
- Add row actions in TaskList: close, reopen, cancel.
- Confirm dangerous actions and refresh list after success.
- If backend rejects transition (409/400), show a clear conflict message with requestId.
...
- Use dropdown row actions to keep table clean.
- Confirm modals should be token-aligned and accessible.
...
- Evidence Log:
  - `task/frontend/FE-2/FE-2-08_evidence.md` (add)
...
Write `task/frontend/FE-2/FE-2-08_evidence.md` including:
