# BE-APIv4-045_billing_post_offsets — billing POST /offsets
...
curl -i -H "Authorization: Bearer $FPMS_TOKEN" -H "Content-Type: application/json" -d '{}' "http://localhost:8000/api/v1/offsets"
```

## Prompt
In `backend/app/modules/billing/api.py`, implement ONLY the endpoint `POST /offsets` according to `billing/docs/bill_02_api.md`.
