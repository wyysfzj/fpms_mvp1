# BE-APIv4-025_fees_get_fees_drafts — fees GET /fees/drafts
...
curl -i -H "Authorization: Bearer $FPMS_TOKEN" "http://localhost:8000/api/v1/fees/drafts"
```

## Prompt
In `backend/app/modules/fees/api.py`, implement ONLY the endpoint `GET /fees/drafts` according to `fees/docs/fee_02_api.md`.
