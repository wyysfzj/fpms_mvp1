# BE-APIv4-040_billing_get_bills_id — billing GET /bills/{id}
...
curl -i -H "Authorization: Bearer $FPMS_TOKEN" "http://localhost:8000/api/v1/bills/REPLACE_ID"
```

## Prompt
In `backend/app/modules/billing/api.py`, implement ONLY the endpoint `GET /bills/{id}` according to `billing/docs/bill_02_api.md`.
