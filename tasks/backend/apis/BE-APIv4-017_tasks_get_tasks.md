# BE-APIv4-017_tasks_get_tasks — tasks GET /tasks
...
## Prompt
In `backend/app/modules/tasks/api.py`, implement ONLY the endpoint `GET /tasks` according to `tasks/docs/task_02_api.md`.
