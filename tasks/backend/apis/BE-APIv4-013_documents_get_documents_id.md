# BE-APIv4-013_documents_get_documents_id — documents GET /documents/{id}
...
- Implement ONLY `GET /documents/{id}`.
...
## Prompt
In `backend/app/modules/documents/api.py`, implement ONLY the endpoint `GET /documents/{id}` according to `documents/docs/doc_02_api.md`.
