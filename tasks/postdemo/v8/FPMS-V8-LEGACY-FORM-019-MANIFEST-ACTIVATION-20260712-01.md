...
Create the form-019 lane manifest containing this activation plus exactly `FPMS-V8-OUT-019-SECOND-OA-STATEMENT-20260712-01` after scope 019 is confirmed; no other form task is activated or blocked.
...
- Approved source dependency cell (verbatim): form scope 019 confirmed; notice catalog/seed predecessor PASS; coverage gate
...
- `tasks/postdemo/v8/FPMS-V8-LEGACY-FORM-019-MANIFEST-ACTIVATION-20260712-01.md`
- `tasks/batches/FPMS-POSTDEMO-V8-LEGACY-FORM-019-GATE-20260712-01.md`
- `backend/tests/test_v8_legacy_form_019_manifest_contract.py`
- `artifacts/FPMS-V8-LEGACY-FORM-019-MANIFEST-ACTIVATION-20260712-01/**`
...
- `cd backend && .venv/bin/ruff check --fix tests/test_v8_legacy_form_019_manifest_contract.py && .venv/bin/ruff format tests/test_v8_legacy_form_019_manifest_contract.py && .venv/bin/ruff check tests/test_v8_legacy_form_019_manifest_contract.py`
- `git diff --check -- tasks/batches/FPMS-POSTDEMO-V8-LEGACY-FORM-019-GATE-20260712-01.md backend/tests/test_v8_legacy_form_019_manifest_contract.py artifacts/FPMS-V8-LEGACY-FORM-019-MANIFEST-ACTIVATION-20260712-01/** tasks/postdemo/v8/FPMS-V8-LEGACY-FORM-019-MANIFEST-ACTIVATION-20260712-01.md`
- `./scripts/task_validate.sh FPMS-V8-LEGACY-FORM-019-MANIFEST-ACTIVATION-20260712-01`
- Evidence validation: `python3 /Users/cfcc/.codex/skills/atomic-evidence-gates/scripts/evidence_gate.py validate FPMS-V8-LEGACY-FORM-019-MANIFEST-ACTIVATION-20260712-01 --required-step lint --required-step test --required-step independent_review --required-step scope`
