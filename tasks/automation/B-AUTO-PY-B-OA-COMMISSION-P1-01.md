...
Implement only `TC-B-012` / `handle_tc_b_012`: create OA service fee billing prerequisites, trigger commission generation through real backend billing behavior, and assert commission rows use the OA service fee base and are visible through the commission query path.

## Explicit Non-Closure

Do not implement settlement execution, reply/deadline edit, `TC-B-005`, backend, frontend, or skeleton data changes.
...
- `artifacts/B-AUTO-PY-B-OA-COMMISSION-P1-01/**`
...
- `FPMS_API_URL=http://127.0.0.1:8000/api/v1 FPMS_USERNAME=admin FPMS_PASSWORD="$FPMS_LOCAL_PASSWORD" FPMS_RUN_ID=LOCAL-RUN-BLAND2-012-001 FPMS_DB_DSN= pytest tests/test_wave_b.py -k TC-B-012 -q`
- `./scripts/task_validate.sh B-AUTO-PY-B-OA-COMMISSION-P1-01`

## Evidence Path

- `artifacts/B-AUTO-PY-B-OA-COMMISSION-P1-01/results.jsonl`
- `artifacts/B-AUTO-PY-B-OA-COMMISSION-P1-01/summary.md`
- `artifacts/B-AUTO-PY-B-OA-COMMISSION-P1-01/git/diff.patch`
