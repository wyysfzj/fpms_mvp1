# FPMS Post-Demo V8 Legacy Form-009 Gate
...
- Gate: `DG-LEGACY-FORM-CLASS:form-009`
...
This confirmed negative classification completes the form-009 decision gate without
...
- Task file: `tasks/postdemo/v8/FPMS-V8-LEGACY-FORM-009-MANIFEST-ACTIVATION-20260712-01.md`
- Task file: `tasks/postdemo/v8/FPMS-V8-OUT-009-VOLUNTARY-RECTIFICATION-20260712-01.md`

The activation task is the only current implementation item. The OUT-009 child remains
unstarted until this activation receives current independent acceptance; it then executes as
the only child in the form-009 lane. No form-017 task or other legacy-form task is included.
...
- Form-017 membership in this lane: none
...
behavior, or claim that `主动补正` is a current official form. OUT-009 must apply the accepted
`INTERNAL_ONLY` outcome to form-009 alone, keep it reference-only, and leave form-017 and every
...
separation, and zero product/schema/catalog/ledger scope before OUT-009 may start. This manifest
