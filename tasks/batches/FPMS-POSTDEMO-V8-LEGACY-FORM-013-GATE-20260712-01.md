# FPMS Post-Demo V8 Legacy Form-013 Gate
...
- Gate: `DG-LEGACY-FORM-CLASS:form-013`
...
This confirmed negative classification completes the form-013 decision gate without
...
- Task file: `tasks/postdemo/v8/FPMS-V8-LEGACY-FORM-013-MANIFEST-ACTIVATION-20260712-01.md`
- Task file: `tasks/postdemo/v8/FPMS-V8-OUT-013-PAPER-TO-ELECTRONIC-20260712-01.md`

The activation task is the only current implementation item. The OUT-013 child remains
unstarted until this activation receives current independent acceptance; it then executes as
the only child in the form-013 lane. No task from any other legacy-form lane is included.
...
behavior, or claim that `纸件申请转电子申请请求书` is a current official form. OUT-013 must apply
the accepted `INTERNAL_ONLY` outcome to form-013 alone and leave every other OUT row unchanged.
...
product/schema/catalog/ledger scope before OUT-013 may start. This manifest does not self-approve
