...
- exact three-path scope and diff checks; and
...
No source-registry edit, source activation, source promotion, candidate materializer,
canonical rate data, rate-book or fee-rate write, schema, migration, seed, customer data,
API, UI, calculation, billing, payment, lifecycle, deadline, other CNIPA candidate,
annuity-source path, ledger, disposition, review receipt, old evidence or task-control
mutation is included.

Rollback reverts only these two source files and this story card. It leaves all current
carrier, activation, registry, rate, customer and application bytes unchanged.
