...
- Lean exact Git path/mode/blob fingerprint:
  `67daa76fb1973f991bdf3ec60cb35fc2ccc845fab0bb4b20eae9bf985c8bd8e3`;
- patch SHA-256:
...
The existing fee-obligation core and row 107 instruction writer were independently
re-attested compositionally. All 92 pre-existing service functions/classes, including row
114 `record_payment_evidence`, are unchanged. Their Lean exact Git path/mode/blob
fingerprints are respectively
`dfa3434cd647cc4d32a1b880c669e3e9597c46a042a7bed2ed5f06f866835da3` and
`6f043e166640684d34488448c9d2c7631e0fd72563008ae7071d2b3bd8c092f0`.
