# Expense Case/Client Stats Plan

- date: `2026-04-06`
- target slice: `EXPSTAT-CASECLIENT-01`
...
### `EXPSTAT-CASECLIENT-BE-01`

- exact closure slice:
  - add grouped `case_amounts` and `client_amounts` to expense stats payload
  - cover grouped semantics with targeted backend tests
- explicit non-closure:
  - no worker/department/gross-profit semantics
  - no frontend changes
- allowlist:
...
- verification:
  ...
  - `./scripts/task_validate.sh EXPSTAT-CASECLIENT-BE-01`
- evidence path:
  - `artifacts/EXPSTAT-CASECLIENT-BE-01/**`
- remaining follow-up task ids:
  - `EXPSTAT-CASECLIENT-FE-01`
  - `EXPSTAT-CASECLIENT-QA-01`

### `EXPSTAT-CASECLIENT-FE-01`

- exact closure slice:
  - render grouped per-case and per-client summary cards on `ExpenseList.vue`
- explicit non-closure:
  - no backend changes
  - no worker/department/gross-profit UI
- allowlist:
...
- verification:
  ...
  - `./scripts/task_validate.sh EXPSTAT-CASECLIENT-FE-01`
- evidence path:
  - `artifacts/EXPSTAT-CASECLIENT-FE-01/**`
- remaining follow-up task ids:
  - `EXPSTAT-CASECLIENT-QA-01`
...
- exact closure slice:
  - audit evidence, gates, and scope compliance for the case/client grouped-stat slice
- explicit non-closure:
...
- verification:
  - `./scripts/task_validate.sh EXPSTAT-CASECLIENT-BE-01`
  - `./scripts/task_validate.sh EXPSTAT-CASECLIENT-FE-01`
  - `./scripts/task_validate.sh EXPSTAT-CASECLIENT-QA-01`
- evidence path:
  - `artifacts/EXPSTAT-CASECLIENT-QA-01/**`
- remaining follow-up task ids:
  - `None`
