# Expense Stat Worker Carrier Plan

- date: `2026-04-09`
- design: `docs/superpowers/specs/2026-04-09-expense-stat-worker-carrier-design.md`
...
- `worker carrier authority freeze only`
...
- `EXPSTAT-WORKER-CARRIER-01`
  - owner: `main thread`
  - exact closure slice:
    - freeze business worker carrier authority
...
- future worker implementation, if approved later, must serialize ownership over:
